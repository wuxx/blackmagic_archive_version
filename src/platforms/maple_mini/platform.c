...
void platform_init(void)
{
	...
	gpio_set(SWDIO_PORT,SWDIO_PIN);// nRF51 must not clear SWDIO as this doubles up as the reset pin
	...
	// setup and toggle Maple Mini USB reset pin
	gpio_set_mode(USB_DISC_PORT, GPIO_MODE_OUTPUT_2_MHZ,
	              GPIO_CNF_OUTPUT_OPENDRAIN, USB_DISC_PIN);
