...
#define BOARD_IDENT_DFU   "Black Magic (Upgrade), (Firmware " FIRMWARE_VERSION ")"
#define BOARD_IDENT_UPD   "Black Magic (DFU Upgrade), (Firmware " FIRMWARE_VERSION ")"
...
#define USBUSART_TX_PIN	GPIO6  /* TX2 */
